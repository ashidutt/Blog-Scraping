...
-        self.search_results_num = 50 #set to any variable
-
...
-    NUM_RESULTS_TO_PROCESS = 20 # specify the number of results url to crawl
-    # creating a file to read the search strings
-    GOOGLE_SEARCH_STRING=open('D:\scrapy\GS\goog_search_string.txt','r')
-
-    print 'Start search'
-    
-    ## Parameters setting
-    #search_words='1mdb'
-    # The search strings read from the file are converted to list format
-    search_words = list(GOOGLE_SEARCH_STRING)
...
-    spider_file_path = r'D:\scrapy\GS\GS\spiders'
